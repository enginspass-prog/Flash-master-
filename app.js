...
function init(){
  ...
  var dex=document.getElementById("dash-expert-btn");if(dex)dex.addEventListener("click",function(){var eb=document.querySelector(".expert-board");if(eb)eb.scrollIntoView({behavior:"smooth",block:"start"});});
...
function exportProfile(){
  ...
  a.href=url;
  a.download="flashcards4u_profile_v69_"+new Date().toISOString().slice(0,10)+".json";
  a.click();
